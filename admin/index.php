...
<body style="background-color: #0074c9;">
    ...
    <p style="text-align: right; padding-right: 15px;"><a href="tab.php" style="color: #fff;">Tableau des 10 derniers produits</a></p>
    <div class="main row mx-auto">
            ...
            <div class="contents ">';
                    ...
                    echo '<p>'.$value['date'].'</p>';
                    echo '<p style="text-align: center;"><a href="../delete.php?id='.$value['id'].'">Supprimer</a> / <a href="../update.php?id='.$value['id'].'">Modifier</a></p>';
                    echo '</div>
                    </div> ';
                }
                ?>
